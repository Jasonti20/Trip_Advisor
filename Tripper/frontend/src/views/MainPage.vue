<template>
  ...
  >
    ...
    <a-form-item name="personality" label="personality" :rules="config.rules">
      <a-input v-model:value="formState.personality" />
    </a-form-item>
    <a-form-item
      :wrapper-col="{
        xs: { span: 24, offset: 0 },
  ...
  setup() {
    ...
    const plan = async () => {
      try {
        ...
        // navigate to the /plan page and pass the response data as a query parameter
        router.push({
          name: "plan",
          query: {
